	...
	run: function(spawner) {
		...
		if (spawner.spawning) {
			...
			if (spawner.room.memory.harvesters < 2) {
				...
				if (spawner.spawnCreep([MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,RANGED_ATTACK,MOVE], (spawner.name + ' ranger ' + Game.time), {memory: {role: 'ranger', home: spawner.room.name}}) == OK) {
